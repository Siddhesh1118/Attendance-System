...
start = time.time()
period = 8
face_cas = cv2.CascadeClassifier('C:/Users/User/Desktop/EXPERIMENTS/Automatic_attendence_system_using_facial_recognition_python_openCV-main/haarcascades/haarcascade_frontalface_default.xml')
